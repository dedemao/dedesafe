...
class dedesafe
{
    ...
    {
        global $adminPath;
        $adminPath = str_replace($this->dirname,'',$adminPath);
        $phpDirs = array('uploads','a','templets','skin','html','images','js','/include/ckeditor/adapters','/include/ckeditor/plugins/','/include/ckeditor/skins/','/include/ckeditor/themes/','/plus/img/','/dede/images/',$adminPath.'/css/',$adminPath.'/js/',$adminPath.'/templets/');
        $msg = array();
